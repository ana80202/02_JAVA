...
public class MapService {
	...
	public void method1() {
		...
		System.out.println(map.get(0));  //null //값이 없으면 null로 나옴
		...
		//5.void clear() : 모든 Entry삭제
		//6. boolean isEmpty() : 비어 있는지 확인
		
		System.out.println("caler() 전 isEmpty() : " + map.isEmpty()); //false
