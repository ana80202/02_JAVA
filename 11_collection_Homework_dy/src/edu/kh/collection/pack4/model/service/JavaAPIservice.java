...
public class JavaAPIservice {
	...
	public void method2( ) {
		...
		System.out.println("[Stirng -> 기본 자료형 변환]");
		...
		//-> 코드는 길지만 효율이 좋음
		int test2 = 400;
		String change2 = Integer.valueOf(test2).toString(); //long + String -> String
	...
	/**
	 * String의 불변성(inmutable , 변하지 않는 성질 == 상수) 변할수 있음 (mutable)
	 * -문자열이 수정되면 새로운 String 객체가 생성됨
	 */
	public void method3( ) {
		
		//System.identitiyHashCode(str(문자열))
		//-> 주소 값을 이용해서 만든 해시코드(식별번호)
		//-> 같은 객체에 저장된 값이 변햇다면 주소는 일정해야 한다!
		//identityHasnCode도 일정해야 된다
	...
	public void method5( ) {
		...
		//StringBuilder / StringBuffer (가변성 : muterable)
	...
	public void method6( ) {
		...
		//2월 21일오늘 점심은무엇을 먹을까요
		String[] arr = temp.split(" "); //생각보다 자주 사용하니까 익혀두기
