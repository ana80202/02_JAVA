...
public class FileService {
	...
	public void method1() {
		...
		File directory = new File("/io_test/20230222");
		//-> 처음 : 존재하지 않는 폴더를 관리하는 File객체 생성
		
		System.out.println("존재 여부 확인 : " + directory.exists());
		
		if(!directory.exists()) {//폴더가 존재 하지 않으면
	...
	public void method3() {
		...
		//File객체생성
		File directory = new File("\\workspace\\02_Java\\13_IO");
...
//			System.out.println(lastModified);
			...
			//Strung SimpleDateFormat.format(long) : 
