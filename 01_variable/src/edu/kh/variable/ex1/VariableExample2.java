...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		//*카멜표기법
		//연결되는 두단어 중 후속단어의 첫 문자를 대문자로 표기하는 방법
	...
	// 자료형 변수명 =  리터럴;
		...
		long longNumber = 10000000000L;  //L 또는 l 을 붙여서 long으로 쓴다는 것을 알려줘야 함
        ...
        int int_Number;  // 자바는 카멜표기법 사용
                         ...
                         // MEMBER_NAME
        //5.카멜표기법
        char hellloWorldAppleBananaTomato;
