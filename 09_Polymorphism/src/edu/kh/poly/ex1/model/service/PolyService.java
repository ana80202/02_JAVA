...
public class PolyService {
	...
	public void ex1() {
		...
		car2.setFuel("전기");
		car2.setWheel(4);
		//car2.seBatteryCapacity(1000000);
		//The method seBatteryCapacity(int) is undefined for the type Car
		...
		//객체 배열 : 같은 객체 참조 자료형의 변수를 하나의 묶음으로 다루는 것
		             // 부모타입 참조 자효형의 변수를 하나의 묶음으로 다루는 것
		...
		//상속 + 다형성
		//상속 특징 : car상속 클래스는 모두 getEngine()을 가지고 있다를 정의
	...
	//전달받은 Car또는 자식개체(Tesla,Spark)의 엔진 연료 바퀴갯수를 출력하는 메소드
...
//	 Spark s1  = (Spark)c1;
	...
	public void ex5() {
		...
		//프로그램 "실행 전"
		//- 컴파일러는 getEnginr() 메소드가 Car에 있는걸로 인식해서
		// c1.getEngone() 호출코드와
