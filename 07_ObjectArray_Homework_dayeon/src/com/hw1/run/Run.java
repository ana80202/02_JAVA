...
public class Run {
	...
	public static void main(String[] args) {
	    ...
	    //1. 객체배열을 크기 3으로 할당한 뒤 3개의 생성자를 이용하여 각각 생성한 후 출력
		Employee emp[] = new Employee[3];
	
	    emp[0] = new Employee(); //기본 생성자
	    emp[1] = new Employee(1, "홍길동", 19 , 'M' , "01022223333","서울 잠실"); //6개자리 매개변수 생성자 
	    emp[2] = new Employee(2, "강말순","교육부","강사",20,'F',10000000,0.01,"01011112222","서울마곡"); 
