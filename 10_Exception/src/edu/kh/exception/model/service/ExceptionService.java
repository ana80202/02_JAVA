...
public class ExceptionService {
	...
	//2) Checked Exception : 필수적으로 예외 처리 (ex. IOEException, 나머지...)
	
	private Scanner sc = new Scanner(System.in);
	//노란색으로 sc 뜰때 확인해보면 memory leak이라고 뜸(메모리 누수)
	//스캐너를 꼭 닫아줘야 한다!
	...
	public void ex1() {
		...
		try {
			...
			//Exception in thread "main" java.lang.ArithmeticException : 산술적 예외 (0으로 나눌 수 없다)
			//예외가 발생할 것 같은 코드를 try안에 넣어준다
			
		}catch(ArithmeticException e ) { //exception의 매개변수는 e로 설정
	...
	public void ex2() {
		...
		try {
		System.out.print("입력1 : ");  // InputMismatchException
		int num1 = sc.nextInt();
		
		System.out.print("입력2 : ");  // InputMismatchException
		int num2 = sc.nextInt();
