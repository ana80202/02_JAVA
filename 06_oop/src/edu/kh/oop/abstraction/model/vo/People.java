...
// VO(vlaue object) : 값 저장용 객체를 만들기 위한 클래스를 모아두는 패키지
...
// 접근제한자 : public
	...
	private int age;
	//public double botCoin;  // 공통점이 아니므로 제거해야하는 필드
...
//   -> Generater Getters and Setters ... 클릭
	//-> selectAll -> generate

	
    // name : 변수의 값을 돌려 보내주는 간접접근 기능
	
	// void : 반환할 값이 없다(반환형이 없다)
	// <-> 반환할 값이 있을 경우 그밧의 자료형을 작성(반환형)
