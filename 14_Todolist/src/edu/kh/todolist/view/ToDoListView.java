...
import edu.kh.todolist.model.service.TodoListServiceiImpl;

//View :보여지는 부분(내용 출력/키보드 입력)의 역할
public class ToDoListView {
	...
	public ToDoListView(){
		...
		try {
			//부모타입 참조변수 = 자식객체
			service = new TodoListServiceiImpl(); //다형성 업캐스팅
	...
	public void todoDetailView() {
		...
		// 할 일 목록 + 완료된 개수 카운트한 값 얻어오기
		//	(List)         (int)
		Map<String, Object> map = service. todoDetailView();
