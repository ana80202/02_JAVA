...
public class Array2Example {
	...
	public void ex1() {
		...
		arr = new int[2][3];
		// heap 영역에 int2차원 배열 2행 3열 공간을 할당		
...
//		int[] arr = {1,2,3,4,5};
	...
	public void ex3() {
		...
		arr[0] = new char[3]; // 0행에 3열짜리 1차원 배열을 생성해서 주소값 저장
		arr[1] = new char[4];// 1행에 4열짜리 1차원 배열을 생성해서 주소값 저장
		arr[2] = new char[5];// 2행에 5열짜리 1차원 배열을 생성해서 주소값 저장
		arr[3] = new char[2];// 3행에 2열짜리 1차원 배열을 생성해서 주소값 저장
		// 4행짜리 생성해서 위에 처럼 생성됨
